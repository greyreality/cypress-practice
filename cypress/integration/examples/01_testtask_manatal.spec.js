...
describe("Run tests for Manatal login page", () => {
  ...
  it.only("TEST-01 Success registration as Agency with phone", () => {
    ...
    cy.get("#company_email_address").type("rita.leontyeva+30@candidate.manatal.com")
    cy.get("#confirm_company_email_address").type("rita.leontyeva+30@candidate.manatal.com")
    ...
    cy.contains("rita.leontyeva+30@candidate.manatal.com")
